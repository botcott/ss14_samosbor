...
reagent-desc-arcryox = Специализированная смесь для криогенной терапии, предотвращающая повреждение клеток при экстремально низких температурах.
reagent-physical-desc-arcryox = морозный
reagent-name-heparin = гепарин
reagent-desc-heparin = Препарат, предотвращающий свертывание крови и помогающий при лечении тромбов.
